...
<head>
    ...
    <style>
        * {
        ...
        .stat-card.success { background: linear-gradient(135deg, #4ecdc4 0%, #44a08d 100%); }
        .stat-card.warning { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); }
        .stat-card.danger { background: linear-gradient(135deg, #fd746c 0%, #ff9068 100%); }
        ...
        .badge-admin { background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%); color: white; }
        .badge-manager { background: linear-gradient(135deg, #f39c12 0%, #e67e22 100%); color: white; }
        .badge-mechanic { background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); color: white; }
        .badge-reception { background: linear-gradient(135deg, #9b59b6 0%, #8e44ad 100%); color: white; }
    ...
    <div class="admin-container">
        <div class="admin-header">
            <div class="header-content">
                ...
                <div class="subtitle">Административная панель Autoservice</div>
            </div>
        ...
        <div class="admin-content">
            ...
            <div class="toggle-buttons">
                <div class="toggle-btn active" data-target="settings-section">
                    ⚙️ Основные настройки
                </div>
                <div class="toggle-btn" data-target="company-section">
                    🏛️ Реквизиты компании
                </div>
                <div class="toggle-btn" data-target="users-section">
                    👥 Управление пользователями
                </div>
                <div class="toggle-btn" data-target="system-section">
            ...
            <div id="settings-section" class="hidden-section active">
                <div class="card">
                    <div class="card-header">⚙️ Основные настройки системы</div>
                    <div class="card-body">
                        <form method="post">
                            <div class="form-grid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="system-info-grid">
                            <div class="info-card">
                                <h4>🖥️ Сервер</h4>
                                <div><strong>PHP версия:</strong> <?= phpversion() ?></div>
                                ...
                                <div><strong>Время сервера:</strong> <?= date('d.m.Y H:i:s') ?></div>
                            </div>
                            ...
                            <div class="info-card">
                                ...
                                <div><strong>Активные заказы:</strong> <?= $stats['active_orders'] ?? 0 ?></div>
                                <div><strong>Завершено в этом месяце:</strong> <?= $stats['completed_this_month'] ?? 0 ?></div>
                            </div>
                        </div>
                    </div>
                </div>
