...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 16 2025 г., 09:06
...
INSERT INTO `employees` (`id`, `name`, `position`, `type`, `phone`, `specialty`, `specialization`, `work_hours`, `created_at`, `salary_type`, `base_rate`, `percentage_rate`, `sales_percentage`, `active`) VALUES
(1, 'Иванов Алексей Сергеевич', 'Старший механик', 'employee', NULL, NULL, 'all', '9:00-18:00', '2025-11-16 05:31:22', 'percentage', 15000.00, 15.00, 0.00, 1),
(2, 'Петров Дмитрий Владимирович', 'Механик', 'employee', NULL, NULL, 'front_axis', '9:00-18:00', '2025-11-16 05:31:22', 'percentage', 15000.00, 12.00, 0.00, 1),
(3, 'Сидорова Марина Игоревна', 'Менеджер по запчастям', 'employee', NULL, NULL, 'all', '9:00-18:00', '2025-11-16 05:31:22', 'sales', 16242.00, 0.00, 5.00, 1),
(4, 'Николаева Ольга Викторовна', 'Администратор', 'employee', NULL, NULL, 'all', '9:00-18:00', '2025-11-16 05:31:22', 'fixed', 45000.00, 0.00, 0.00, 1),
(5, 'Козлов Антон Петрович', 'Механик', 'employee', NULL, NULL, 'rear_axis', '9:00-18:00', '2025-11-16 05:31:22', 'percentage', 15000.00, 10.00, 0.00, 1),
(6, 'Иван Иванов', 'Мастер по ремонту', 'mechanic', '+7 900 123-45-67', 'Мастер по ремонту', 'all', '9:00-18:00', '2025-11-16 06:56:54', 'percentage', 22440.00, 0.00, 0.00, 1),
(7, 'Петр Петров', 'Диагност', 'mechanic', '+7 901 234-56-78', 'Диагност', 'all', '9:00-18:00', '2025-11-16 06:56:54', 'percentage', 22440.00, 0.00, 0.00, 1),
(8, 'Стрункин Василий', 'Шинка', 'mechanic', '+7 (122) 222-22-22', 'Шинка', 'all', '9:00-18:00', '2025-11-16 06:56:54', 'percentage', 22440.00, 0.00, 0.00, 1);
...
INSERT INTO `parts` (`id`, `code`, `name`, `part_number`, `quantity`, `price`) VALUES
(7, 'P007', 'Ремкомплект тормозного суппорта | перед |', 'BC-0208', 1, 500.00),
(8, 'P008', 'Пыльник ШРУСа', ' PC-2081', 1, 550.00),
(9, 'P009', 'Подвеска, рычаг независимой подвески колеса', 'C8015', 2, 420.00),
(10, 'P010', 'Защитный колпак / пыльник, амортизатор', '22161 01', 1, 400.00),
(11, 'P011', 'Тяга рулевая | перед прав/лев |', 'C2499LR', 1, 1000.00),
(12, 'P012', 'Колодки тормозные дисковые | зад |', 'BD-4407', 1, 1100.00),
(13, 'P013', 'Подвеска, рычаг независимой подвески колеса', '510310', 1, 862.00),
(14, 'P014', 'Комплект пыльника, рулевое управление', '540329S', 2, 652.00),
(15, 'P015', 'Ступица колеса', '9237002K', 1, 3327.00),
(16, 'P016', 'Тяга / стойка, стабилизатор', 'S050077', 2, 1210.00),
(17, 'P017', 'Масло трансмиссионное Специальное ATF AG-52 1л', '82111Л', 3, 1655.00),
(18, 'P018', 'Рабочий цилиндр, система сцепления', '3540', 0, 1380.00),
(19, 'P019', 'Рычаг подвески | зад лев |', 'SH-1910', NULL, 4200.00),
(20, 'P020', 'Комплект тормозных колодок, дисковый тормоз', 'BD-1413', NULL, 1980.00),
(23, 'P023', 'Подвеска, корпус колесного подшипника', '821902', 2, 7800.00),
(24, '99', 'Амортизатор', 'G12716LR', 2, 12720.00),
(25, 'P025', 'Поперечная рулевая тяга', 'C3004L', 1, 3320.00),
(26, 'P026', 'Сайлентблок заднего рычага подвески | зад прав/лев |', 'C9408', 1, 2450.00),
(27, 'P027', 'Сайлентблок заднего рычага подвески | зад прав/лев |', 'C9409', 1, 3060.00);
...
--
-- Структура таблицы `salary_calculations`
--
...
CREATE TABLE `salary_calculations` (
  ...
  `orders_total` decimal(10,2) DEFAULT '0.00',
  `parts_sales` decimal(10,2) DEFAULT '0.00',
  `bonus` decimal(10,2) DEFAULT '0.00',
  `penalty` decimal(10,2) DEFAULT '0.00',
  `calculated_salary` decimal(10,2) DEFAULT '0.00',
  `status` enum('draft','calculated','paid') COLLATE utf8mb3_unicode_520_ci DEFAULT 'draft',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_520_ci;
...
CREATE TABLE `salary_payments` (
  ...
  `month` date NOT NULL,
  `work_amount` decimal(10,2) DEFAULT '0.00',
...
INSERT INTO `salary_payments` (`id`, `employee_id`, `month`, `work_amount`, `sales_amount`, `base_salary`, `bonus_amount`, `total_salary`, `payment_date`, `created_at`) VALUES
(1, 1, '2025-01-01', 50000.00, 0.00, 22440.00, 7500.00, 29940.00, '2025-01-10', '2025-11-16 06:46:31'),
(2, 2, '2025-01-01', 0.00, 80000.00, 22440.00, 8000.00, 30440.00, '2025-01-10', '2025-11-16 06:46:31'),
(3, 3, '2025-01-01', 0.00, 0.00, 35000.00, 0.00, 35000.00, '2025-01-10', '2025-11-16 06:46:31');
...
(0, 'Двигатель', NULL, '2025-11-16 08:04:32', NULL),
(0, 'Трансмиссия', NULL, '2025-11-16 08:04:32', NULL),
(0, 'Тормозная система', NULL, '2025-11-16 08:04:32', NULL),
(0, 'Подвеска', NULL, '2025-11-16 08:04:32', NULL),
(0, 'Электрика', NULL, '2025-11-16 08:04:32', NULL),
(0, 'Кузовные детали', NULL, '2025-11-16 08:04:32', NULL),
(0, 'Фильтры', NULL, '2025-11-16 08:04:32', NULL),
(0, 'Масла и жидкости', NULL, '2025-11-16 08:04:32', NULL);
...
--
-- AUTO_INCREMENT для таблицы `salary_calculations`
--
ALTER TABLE `salary_calculations`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
